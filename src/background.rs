...
mod imp {
    ...
    #[properties(wrapper_type = super::BackgroundPaintable)]
    ...
    impl ObjectSubclass for BackgroundPaintable {
        ...
        const NAME: &'static str = "EuphoniaBackgroundPaintable";
...
glib::wrapper! {
    pub struct BackgroundPaintable(ObjectSubclass<imp::BackgroundPaintable>) @implements gdk::Paintable;
}
